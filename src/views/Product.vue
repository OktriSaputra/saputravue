...
import HeaderSaputra from '@/components/HeaderSaputra.vue'
import FooterSaputra from '@/components/FooterSaputra.vue'
import RelatedSaputra from '@/components/RelatedSaputra.vue'
